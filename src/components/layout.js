...
<div class="relative bg-white overflow-hidden">
        ...
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              ...
              title="Share on whatsapp" class="w-full flex items-center justify-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 md:py-2 md:text-lg md:px-4">
  ...
  <div class="lg:absolute lg:inset-y-0 lg:insert-x-0 invert-0">
        <StaticImage 
